      ...
      <div class="header container">
        <div class="nav-bar">
          ...
          <div class="nav-list">
            ...
            <ul>
              <li><a href="#product" data-after="Tier">타이어</a></li>
              <li class="drop"><a href="#services" data-after="services" class="dropbtn">서비스 <span class="fa fa-plus"></span></a>
                <ul class="dropdown">
              ...
              <li><a href="#event" data-after="event">이벤트</a></li>
              <li class="drop"><a href="#customer" data-after="Customer center">고객센터 <span class="fa fa-plus"></span></a>
                <ul class="dropdown">
                  <li><a href="#customer">공지 사항</a></li>
                  <li><a href="#contact">1:1 고객상담</a></li>
